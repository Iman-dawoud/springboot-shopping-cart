...
import com.dailycodework.shoppingcart.repository.UserRepository;
...
public class UserService implements IUserService {
    ...
    public User getAuthenticatedUser() {
        ...
        //The SecurityContextHolder is a globally accessible storage for authentication details in Spring Security.
        // It allows any part of the application to access the currently authenticated user,
        // even in classes that are completely separate from the filter.
    }
}